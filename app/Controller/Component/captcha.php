...
class CaptchaComponent extends Object
{
  ...
  {
    /*
     * list all possible characters, similar looking characters and vowels have
     * been removed
     */
  ...
  function create($width = '120', $height = '40', $characters = '6')
  {
     ...
     */
    $textbox = imagettfbbox($font_size, 0, WWW_ROOT . DS . $this->font, $code) or
         die('Error in imagettfbbox function');
    $x = ($width - $textbox[4]) / 2;
    $y = ($height - $textbox[5]) / 2;
    $y -= 5;
    imagettftext($image, $font_size, 0, $x, $y, $text_color, WWW_ROOT . DS . $this->font, $code) or
